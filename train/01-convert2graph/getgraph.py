...
@click.option("--first_id", default=0, help="first entry id to start searching the data")
@click.option("--last_id", default=-1, help="last entry id to start searching the data (set -1 to search all entries)")
def cli(**kwargs):
    print(kwargs)
